...
export class ApiService {
  ...
  post(requestParam: any) {
    return this.http
      .post(environment.baseUrl + requestParam.url, requestParam.payload)
      .pipe(
        tap((data: any) => {
          return data;
        }),
  ...
  delete(requestParam: any) {
    return this.http.delete(environment.baseUrl + requestParam.url).pipe(
      tap((data: any) => {
        return data;
      }),
      catchError(this.handleError([]))
